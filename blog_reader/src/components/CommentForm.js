    ...
    const submitComment = async (e) => {
        ...
        try {
            ...
            if (!editCommentId) {
                ...
                response = await fetch(`${process.env.REACT_APP_BLOGAPI_URL}/post/${postId}/comment/create`, {
                    method: 'POST',
                    credentials: 'include',
                    headers: {
                ...
                response = await fetch(`${process.env.REACT_APP_BLOGAPI_URL}/post/${postId}/comment/${editCommentId}/update`, {
                    method: 'PUT',
                    credentials: 'include',
                    headers: {
                        'Accept': 'application/json',
