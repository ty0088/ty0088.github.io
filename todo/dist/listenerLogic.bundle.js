...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "contentUpdater": () => (/* binding */ contentUpdater)
/* harmony export */ });
...
const contentUpdater = (function () {
    ...
    function refreshProjList() {
        const projListArr = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewProjList();
        document.getElementById('project-content').innerHTML = '';
    ...
    function editTodoForm(indexID) {
        ...
        let newDate = '';
        if (isNaN(currDate)) {
            newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateElem.textContent, 'dd/MM/yyyy', new Date()), 'yyyy-MM-dd');
        }
        ...
        let tempProjList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewProjList();
...
/* harmony export */ });
/* harmony import */ var _listLogic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./listLogic */ "./src/listLogic.js");
/* harmony import */ var _filterLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filterLogic */ "./src/filterLogic.js");
/* harmony import */ var _contentLogic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contentLogic */ "./src/contentLogic.js");
/* harmony import */ var _listenerLogic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./listenerLogic */ "./src/listenerLogic.js");
...
const controller = (function () {
    ...
    function click(event) {
        ...
        if (clickType === 'all') {
            ...
            dateOrder = true;
            priorityOrder = true;
            tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byAll();
            listHead = 'All';
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(tempList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();

        } else if (clickType === 'today') {

            dateOrder = true;
            priorityOrder = true;
            tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byToday();
            listHead = 'Today';
            const sortedList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(tempList);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(sortedList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();

        } else if (clickType === 'week') {

            priorityOrder = true;
            tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byWeek();
            listHead = 'Week';
            const sortedList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(tempList);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(sortedList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
            ...
            dateOrder = true;
            priorityOrder = true;
            tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byCompleted();
            listHead = 'Completed';
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(tempList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
            ...
            tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byProject(projName);
            listHead = projName;
            const sortedList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(tempList);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(sortedList, projName);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();

        } else if (clickType === 'add-proj') {

            refreshCurrList(listHead);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleProjForm(false);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickProj();

        } else if (clickType === 'edit-proj') {

            const projList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewProjList();
            currProjName = projList[indexID];
            refreshCurrList(currProjName);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.editProjForm(indexID, currProjName);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickEditProj();
            ...
            currProjName = projList[indexID];
            refreshCurrList(currProjName);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.deleteProjectForm(indexID, _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewProjList()[indexID]);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickDelProj();

        } else if (clickType === 'del-proj-name') {

            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.deleteProject(indexID);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshProjList();
            listHead  = 'All';
            refreshCurrList(listHead);
            ...
            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.deleteProjTodos(indexID);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshProjList();
            listHead  = 'All';
            refreshCurrList(listHead);
            document.getElementById('proj-del-form').remove();
            ...
            tempList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortPriority(tempList, priorityOrder);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(tempList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
            ...
            dateOrder = !dateOrder;
            tempList = _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortDate(tempList, dateOrder);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(tempList, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
            ...
            refreshCurrList(listHead);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleTodoForm(false, listHead);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickTodo();

        } else if (clickType === 'check-box') {

            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.completeTodo(indexID);
            refreshCurrList(listHead);
            ...
            if (!!document.querySelector('.detail-border') && parseInt(document.querySelector('.detail-border').getAttribute('data-index')) === indexID) {
                ...
                refreshCurrList(listHead);
                const todoObj = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(indexID);
                _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.detailElement(indexID, todoObj);
            }
            ...
            const todoObj = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(indexID);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.detailElement(indexID, todoObj);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.editTodoForm(indexID);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickEditTodo();

        } else if (clickType === 'delete-todo') {

            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.confirmDelTodo(indexID);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickDelTodo();

        } else if (clickType === 'submit-del-todo') {

            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.deleteTodo(indexID);
            refreshCurrList(listHead);
            ...
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleProjForm(true);
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
            ...
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleTodoForm(true)
            _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
    ...
    function submitProjValue() {
        ...
        if (!nameValue || !nameValue.trim()) {
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.emptyWarning();
        } else if (_listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewProjList().findIndex(projName => projName.toLowerCase() === nameValue.toLowerCase()) === -1) {
            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.addProject(nameValue);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshProjList();
            listHead = nameValue;
            refreshCurrList(listHead);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleProjForm(true);
        } else {
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.duplicateWarning();
        }
    }
    ...
    function submitEditProj(index, currProjName) {
        ...
        if (!nameValue || !nameValue.trim()) {
            ...
            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.editProjectName(index, nameValue);
    ...
    function updateTodoProjName(oldName, newName) {
        let indexArray = _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodoList()
        .filter(todoObj => todoObj.todoProjName === oldName)
        .map(todoObj => todoObj.todoID);
        indexArray.map(index => _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.modTodo(index, newName, _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(index).todoName, _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(index).todoNote, _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(index).todoPriority, _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.viewTodo(index).todoDate));
    }
    ...
    function submitTodoValues() {
        ...
        if (!isNaN(tempDate)) {
            dateValue = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(tempDate), 'dd/MM/yyyy');
        }

        if (!nameValue || !nameValue.trim()) {
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.emptyWarning();
        } else {
            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.addTodo(nameValue, noteValue, projNameValue, priorityValue, dateValue, false);
            refreshCurrList(listHead);
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.toggleTodoForm(true);
        }
    }
    ...
    function submitEditTodo(id) {
        ...
        if (isNaN(dateEditValue)) {
            dateValue = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(dateEditValue), 'dd/MM/yyyy');
        }

        if (!nameEditValue || !nameEditValue.trim()) {
            _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.emptyWarning();
        } else {
            _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.modTodo(id, projEditValue, nameEditValue, noteEditValue, priorityEditValue, dateValue);
            refreshCurrList(listHead);
        }
    }
    ...
    function currList(listHead) {
        if (listHead === 'All') {
            return _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byAll();
        } else if (listHead === 'Today') {
            const dayList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byToday();
            return _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(dayList);
        } else if (listHead === 'Week') {
            const weekList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byWeek();
            return _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(weekList);
        } else if (listHead === 'Completed') {
            return _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byCompleted();
        } else {
            const projList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byProject(listHead);
            return _listLogic__WEBPACK_IMPORTED_MODULE_0__.sortList.sortByUnchecked(projList);
        }
    }
    ...
    function firstLoad() {
        _listLogic__WEBPACK_IMPORTED_MODULE_0__.list.loadFromLocal();
        tempList = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byAll();
        listHead = 'All';
        _contentLogic__WEBPACK_IMPORTED_MODULE_2__.contentUpdater.refreshContent(tempList, listHead);
        _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.clickAll();
        _listenerLogic__WEBPACK_IMPORTED_MODULE_3__.listener.enterKey();
    }
...
function demoValues() {
    const a = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 0}), 'dd/MM/yyyy');
    const b = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 0}), 'dd/MM/yyyy');
    const c = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 2}), 'dd/MM/yyyy');
    const d = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 3}), 'dd/MM/yyyy');
    const e = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 4}), 'dd/MM/yyyy');
    const f = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.now(), {days: 10}), 'dd/MM/yyyy');
...
/* harmony export */ });
/* harmony import */ var _controllerLogic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllerLogic */ "./src/controllerLogic.js");
...
const listener = (function () {
    ...
    function clickAll() {
        ...
        link.forEach(element => element.addEventListener('click', _controllerLogic__WEBPACK_IMPORTED_MODULE_0__.controller.click));
    }
    ...
    function removeClick() {
        const link = document.querySelectorAll('.link');
        link.forEach(element => element.removeEventListener('click', _controllerLogic__WEBPACK_IMPORTED_MODULE_0__.controller.click));
    }                   
    ...
    function enterKey() {
        document.addEventListener("keydown", function (event) {
            if (event.key === 'Enter') {
                ...
                _controllerLogic__WEBPACK_IMPORTED_MODULE_0__.controller.enterValues();
            }
        });
    }
