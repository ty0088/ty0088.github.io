...
const controller = (() => {
    ...
    function clickController(event) {
        ...
        if (clickType === 'all') {
            dateOrder = true;
            priorityOrder = true;
            list = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byAll();
            listHead = 'All';
            ...
            dateOrder = true;
            priorityOrder = true;
            list = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byToday();
            listHead = 'Today';
            ...
            dateOrder = true;
            priorityOrder = true;
            list = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byWeek();
            listHead = 'Week';
            const sortedList = contentUpdater.sortByUnchecked(list);
            contentUpdater.refreshContent(sortedList, listHead);
            clickListener();
            ...
            dateOrder = true;
            priorityOrder = true;
            list = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byCompleted()
            listHead = 'Completed';
            contentUpdater.refreshContent(list, listHead);
            clickListener();
            ...
            list = _filterLogic__WEBPACK_IMPORTED_MODULE_1__.filterLists.byProject(projName);
            listHead = projName;
            const sortedList = contentUpdater.sortByUnchecked(list);
            ...
            dateOrder = !dateOrder;
            list.sort(function(a,b){
                return (dateOrder ? (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(b.todoDate, 'dd/MM/yyyy', new Date()) - (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(a.todoDate, 'dd/MM/yyyy', new Date()) : (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(a.todoDate, 'dd/MM/yyyy', new Date()) - (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(b.todoDate, 'dd/MM/yyyy', new Date()));
            });
            contentUpdater.refreshContent(list, listHead);
            clickListener();
